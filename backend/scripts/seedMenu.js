...
// Bám theo đúng danh mục nhà hàng đang dùng. Trước đây script tự đặt ra bốn
// danh mục của riêng nó, nên chạy vào thực đơn thật là sinh ra "Khai vị" nằm
// cạnh "Món khai vị" và "Tráng miệng" cạnh "Tráng Miệng Lạnh & Bánh" — cột
// lọc món hiện hai mục gần như y hệt nhau. Danh mục nào đã có thì dùng lại,
// chỉ "Món kho & rim" là mới vì không có mục nào đang chứa được món kho.
const CATEGORIES = [
  { name: 'Món khai vị', description: 'Món ăn nhẹ mở đầu bữa, dọn ra trước món chính.' },
  { name: 'Gỏi', description: 'Món trộn chua ngọt, ăn mát miệng và nhẹ bụng.' },
  { name: 'Chiên & Rán', description: 'Món chiên vàng giòn, dọn nóng cùng nước chấm.' },
  { name: 'Cơm & Bún / Mì', description: 'Món no bụng, phần ăn đầy đủ cho một người.' },
  { name: 'Nướng & BBQ', description: 'Món nướng than, thơm mùi khói bếp.' },
  { name: 'Lẩu', description: 'Nồi lẩu dọn giữa bàn, ăn chung nhiều người.' },
  { name: 'Món kho & rim', description: 'Món kho đậm đà, ăn cùng cơm trắng.' },
  { name: 'Tráng Miệng Lạnh & Bánh', description: 'Chè, bánh ngọt và thạch dùng cuối bữa.' },
...
const DISHES = [
  // ── Khai vị ──────────────────────────────────────────────────────────────
  {
    name: 'Gỏi cuốn tôm thịt', category: 'Gỏi', type: 'SideDish',
  ...
  {
    name: 'Chả giò hải sản', category: 'Chiên & Rán', type: 'SideDish',
  ...
  {
    name: 'Nem nướng Nha Trang', category: 'Món khai vị', type: 'SideDish',
  ...
  {
    name: 'Gỏi ngó sen tôm thịt', category: 'Gỏi', type: 'SideDish',
  ...
  {
    name: 'Bánh bèo Huế', category: 'Món khai vị', type: 'SideDish',
  ...
  {
    name: 'Bánh khọt Vũng Tàu', category: 'Chiên & Rán', type: 'SideDish',
  ...
  // ── Món chính ────────────────────────────────────────────────────────────
  {
    name: 'Phở bò tái nạm gầu', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Phở gà ta', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Bún bò Huế', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Bún chả Hà Nội', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Bún riêu cua đồng', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Mì Quảng gà', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Cao lầu Hội An', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Hủ tiếu Nam Vang', category: 'Cơm & Bún / Mì', type: 'MainCourse',
    servingUnit: 'Tô', price: 120000, discount: 0, stock: 30, isFeatured: false,
  ...
  {
    name: 'Cơm tấm sườn bì chả', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Bánh mì thịt nướng', category: 'Cơm & Bún / Mì', type: 'MainCourse',
  ...
  {
    name: 'Bánh xèo miền Tây', category: 'Chiên & Rán', type: 'MainCourse',
  ...
  {
    name: 'Cá kho tộ', category: 'Món kho & rim', type: 'MainCourse',
  ...
  {
    name: 'Thịt kho tàu', category: 'Món kho & rim', type: 'MainCourse',
  ...
  {
    name: 'Gà nướng lá chanh', category: 'Nướng & BBQ', type: 'MainCourse',
  ...
  {
    name: 'Lẩu mắm miền Tây', category: 'Lẩu', type: 'MainCourse',
  ...
  {
    name: 'Bò lúc lắc', category: 'Món kho & rim', type: 'MainCourse',
  ...
  // ── Đồ uống ──────────────────────────────────────────────────────────────
  {
    name: 'Cà phê sữa đá', category: 'Đồ uống', type: 'Drink',
  ...
  {
    name: 'Cà phê trứng', category: 'Đồ uống', type: 'Drink',
  ...
  {
    name: 'Trà sen vàng', category: 'Đồ uống', type: 'Drink',
  ...
  {
    name: 'Nước mía tắc', category: 'Đồ uống', type: 'Drink',
  ...
  {
    name: 'Sinh tố bơ', category: 'Đồ uống', type: 'Drink',
  ...
  {
    name: 'Bia Sài Gòn', category: 'Đồ uống', type: 'Drink',
  ...
  // ── Tráng miệng ──────────────────────────────────────────────────────────
  {
    name: 'Chè hạt sen long nhãn', category: 'Tráng Miệng Lạnh & Bánh', type: 'Dessert',
  ...
  {
    name: 'Chè ba màu', category: 'Tráng Miệng Lạnh & Bánh', type: 'Dessert',
  ...
  {
    name: 'Bánh flan cà phê', category: 'Tráng Miệng Lạnh & Bánh', type: 'Dessert',
  ...
  {
    name: 'Rau câu dừa', category: 'Tráng Miệng Lạnh & Bánh', type: 'Dessert',
...
const main = async () => {
  ...
  // Mã giờ do script tự phát, nên thứ duy nhất nhận ra một món đã có sẵn là
  // chính tên món. "Gỏi ngó sen tôm thịt" đã nằm trong thực đơn thật; đối
  // chiếu theo mã thì nó lọt lưới và bị thêm lần thứ hai.
  const existingNames = new Set(existingDishes.map((dish) => String(dish.name).trim().toLowerCase()));
  const nextCode = createCodeAllocator(existingDishes.map((dish) => dish.code));
  ...
  for (const dish of DISHES) {
    if (existingNames.has(dish.name.trim().toLowerCase())) {
      skipped += 1;
      console.log(`  · bỏ qua ${dish.name} (thực đơn đã có món này)`);
      continue;
    }

    const code = nextCode(dish.category);
    ...
    if (DRY_RUN) {
      created += 1;
      console.log(`  + sẽ thêm ${code.padEnd(6)} ${dish.name}${dish.image ? '' : '  (chưa có ảnh)'}`);
      continue;
    }
    ...
    try {
      ...
      created += 1;
      console.log(`  + đã thêm ${code.padEnd(6)} ${dish.name}${dish.image ? '' : '  (chưa có ảnh)'}`);
    } catch (error) {
      failed.push({ code, name: dish.name, message: error.message });
      console.log(`  ! lỗi    ${code.padEnd(6)} ${dish.name} — ${error.message}`);
    }
  }
