...
const resources = {
  ...
  dishes: { title: 'món ăn', key: 'dishes', loader: getDishes, categoryLoader: getCategories, create: createDish, update: updateDish, remove: deleteDish, restore: restoreDish, fields: ['categoryId', 'code', 'name', 'description', 'type', 'servingUnit', 'price', 'discount', 'stock', 'image'], columns: [['code', 'Mã'], ['name', 'Tên món'], ['price', 'Giá'], ['status', 'Trạng thái']] },
