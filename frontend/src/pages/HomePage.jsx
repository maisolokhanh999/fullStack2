...
import { isStaffRole, normalizeRole } from '../utils/roleNavigation.js'
      ...
      <section className="home-hero">
        <div className="home-hero__nav">
          ...
          <nav aria-label="Điều hướng trang chủ">
            ...
            {isStaffRole(user?.role) && <><Link className="home-staff-link" to={normalizeRole(user?.role) === 'staff' ? '/staff/check-in' : '/admin'}>{normalizeRole(user?.role) === 'staff' ? 'Tra cứu' : 'Quản trị'}</Link><Link className="home-staff-link" to={user?.role === 'admin' ? '/admin' : '/staff/payments'}>Thanh toán</Link></>}
            {user ? (
